RegisterModal = ReactMeteor.createClass({

  templateName: 'RegisterModal',
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body clearfix">
              ...
              <button type="button" className="btn btn-primary pull-right" onClick={this.onClickRegister}>Register</button>
            </div>
          </div>
        </div>
      </div>
