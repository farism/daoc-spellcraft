ModalLogin = ReactMeteor.createClass({
            ...
            <div className="modal-body">
              {this.state.login ? (
                <div className="clearfix">
                  ...
                  <button type="button" className="btn btn-default pull-right" disabled={this.state.loggingIn} onClick={this.onClickLogin}>Login</button>
                </div>
              ) : (
                <div className="clearfix">
                  ...
                  <button type="button" className="btn btn-default pull-right" onClick={this.onClickForgotPassword}>Get password reset link</button>
                </div>
              )}
            </div>
          </div>
  ...
  show: function(cb) {
    this.setState({ login: true, login_email: '', login_password: '', cb: cb || function(){} });
